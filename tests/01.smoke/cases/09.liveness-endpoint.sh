...
log "Case 09.liveness-endpoint: /liveness stays 200 during a state transfer while / reports not ready"
...
ask() { printf 'GET %s HTTP/1.0\r\n\r\n' "$1" | ./galera-healthcheck.sh | head -n1; }
...
log "Case 09.liveness-endpoint passed."
